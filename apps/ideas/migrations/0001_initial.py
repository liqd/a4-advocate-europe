...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Idea',
            fields=[
                ('item_ptr', models.OneToOneField(primary_key=True, auto_created=True, to='a4modules.Item', parent_link=True, serialize=False)),
                ...
                ('idea_location', multiselectfield.db.fields.MultiSelectField(help_text='Please indicate the location of your project. Choose all options that apply. One to three choices possible.', max_length=250, choices=[('city', 'City, country or region'), ('online', 'Online'), ('ruhr_linkage', 'Linkage to the Ruhr area of Germany')])),
                ...
                ('challenge', models.TextField(help_text='Please look here for more information about the annual theme: (link to subpage with more detailed explanation of the annual theme). (max. 300 characters)', max_length=300, verbose_name='What problem or societal need are you working on?')),
                ('outcome', models.TextField(help_text='If your project is selected, what will be different a year from now? What will have changed? Please look here for more information: (link to subpage with explanation on impact). (max. 300 characters)', max_length=300, verbose_name='What would be a successful outcome for your project?')),
                ('plan', models.TextField(help_text='Describe as concretely as possible the approach and / or the method you will use when implementing your idea. What are the steps you plan to take? Please look here for more information: (link to subpage on with explanation on implementation). (max. 500 characters)', max_length=500, verbose_name='How do you plan to get there? Remember to highlight what makes your project design or idea different and innovative.')),
                ('importance', models.TextField(help_text='What motivates you to bring this idea to life? What is your story? What is your personal connection and individual mission behind the idea? (max. 300 characters)', max_length=300, verbose_name='Why is this idea important to you?')),
                ('target_group', models.TextField(help_text='Which target groups, stakeholders, beneficiaries or audiences are at the centre of your project? (max. 300 characters)', max_length=300, verbose_name='Who are you doing it for?')),
                ('members', models.TextField(help_text='Please introduce us to the main members of your project team and briefly summariese their experience and skills. (max. 500 characters)', max_length=500, verbose_name='Who is in your project team?')),
                ...
                ('slug', autoslug.fields.AutoSlugField(populate_from='idea_title', editable=False, unique=True)),
                ('visit_camp', models.BooleanField(default=False)),
                ('is_winner', models.BooleanField(default=False)),
                ('community_award_winner', models.BooleanField(default=False)),
                ('collaborators', models.ManyToManyField(to=settings.AUTH_USER_MODEL, blank=True, related_name='idea_collaborators')),
            ],
            options={
                'abstract': False,
                'ordering': ['-created'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collaboration_camp_option', models.CharField(help_text='Choose one of the following options. More information about the two tracks is available here: (Link).', max_length=255, choices=[('single_track', 'Single track'), ('partner_track', 'Partner track'), ('not_sure', "I'm not sure yet")])),
                ('collaboration_camp_represent', models.TextField(help_text='(Specify one person only. (max 150 characters))', max_length=150, verbose_name='Who will represent your idea at the Collaboration Camp and why?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partners_more_info', models.TextField(help_text='Please use this field if you have more than 3 partner organisations or if you want to tell us more about your proposed partnership arrangements (max. 200 characters).', max_length=200, blank=True)),
                ('slug', autoslug.fields.AutoSlugField(populate_from='idea_title', editable=False, unique=True)),
                ('collaborators', models.ManyToManyField(to=settings.AUTH_USER_MODEL, blank=True, related_name='ideasketcharchived_collaborators')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('selection_apart', models.TextField(help_text='What is surprising or unconventional about your idea? What is special about your idea?', max_length=500, verbose_name='What makes your idea stand apart?')),
                ('selection_relevance', models.TextField(help_text='How will your project connect to, or influence, people’s daily lives?', max_length=500, verbose_name='What is the practical relevance of your idea to people’s everyday lives?')),
