...
TOTAL_BUDGET_TITLE = 'Total Budget'
TOTAL_BUDGET_HELP = ('Please indicate your overall budget. '
                     'The total budget may (but does not have to) '
                     'include the applicant’s own contribution '
                     'and/or external sources of funding.')
BUDGET_REQUESTED_TITLE = 'Funding requested from Advocate Europe'
BUDGET_REQUESTED_HELP = ('Funding requested from Advocate Europe '
...
MAJOR_EXPENSES_TITLE = 'Major expenses'
MAJOR_EXPENSES_HELP = ('Which are the major expenses you foresee '
...
OTHER_SOURCES_TITLE = 'Other sources of income'
OTHER_SOURCES_HELP = ('This will not be published and will only be seen'
                      ...
                      'or financial aid)?')
OTHER_SOURCES_SECURED_TITLE = 'Are these financial sources secured? Yes/no'
OTHER_SOURCES_SECURED_HELP = 'If yes, have these already been secured?'
